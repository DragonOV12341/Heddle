...
TVM_REGISTER_PASS_CONFIG_OPTION(kEnableHeddleConsumerSchedule, Bool);
TVM_REGISTER_PASS_CONFIG_OPTION(kEnableAutoTLPipelineSMT, Bool);
TVM_REGISTER_PASS_CONFIG_OPTION(kHeddleUsePreciseLatency, Bool);
TVM_REGISTER_PASS_CONFIG_OPTION(kHeddleUseAlapPriority, Bool);
TVM_REGISTER_PASS_CONFIG_OPTION(kHeddleBufferSpanAware, Bool);
TVM_REGISTER_PASS_CONFIG_OPTION(kHeddleUsePhaseB, Bool);
TVM_REGISTER_PASS_CONFIG_OPTION(kHeddleRelaxProducerBoundary, Bool);
TVM_REGISTER_PASS_CONFIG_OPTION(kFineGrainedWsProducerThreadExtent, Integer);
TVM_REGISTER_PASS_CONFIG_OPTION(kFineGrainedWsEnableThreeRole, Bool);
TVM_REGISTER_PASS_CONFIG_OPTION(kFineGrainedWsDualConsumer, Bool);
TVM_REGISTER_PASS_CONFIG_OPTION(kFineGrainedWsConsumerStageMap, String);
TVM_REGISTER_PASS_CONFIG_OPTION(kFineGrainedWsBarrierHints, String);
TVM_REGISTER_PASS_CONFIG_OPTION(kFineGrainedWsStageOffsets, String);
TVM_REGISTER_PASS_CONFIG_OPTION(kPersistentKernel, Bool);
TVM_REGISTER_PASS_CONFIG_OPTION(kPersistentNumSms, Integer);
TVM_REGISTER_PASS_CONFIG_OPTION(kPersistentL2Swizzle, Bool);
...
TIR_DEFINE_TL_BUILTIN(named_barrier_wait)
    .set_num_inputs(2)
    .set_attr<TCallEffectKind>("TCallEffectKind",
                               Integer(CallEffectKind::kOpaque));
